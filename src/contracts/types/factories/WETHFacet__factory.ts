...
import type { WETHFacet, WETHFacetInterface } from '../WETHFacet';
...
export class WETHFacet__factory {
  static readonly abi = _abi;
  static createInterface(): WETHFacetInterface {
    return new utils.Interface(_abi) as WETHFacetInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): WETHFacet {
    return new Contract(address, _abi, signerOrProvider) as WETHFacet;
  }
}
